...
export const DecryptionAnalysis = ({ decryptionSteps = [] }) => {
    if (!decryptionSteps || decryptionSteps.length === 0) return null;

    return (
        <div className="analysis-block">
            <div className="analysis-block-header">
                04 / DECRYPTION ANALYSIS
            </div>

            <div className="step-subcard-list">
                {decryptionSteps.map((stepObj) => {
